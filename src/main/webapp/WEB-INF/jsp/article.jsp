        ...
        <div class="container">
            <div class="row">
				<main class="col-md-8 main-content">
					...
					<p style="font-size:16px;font-family:'Microsoft YaHei', u5FAEu8F6Fu96C5u9ED1, Arial, SimSun, u5B8Bu4F53;">
						<a id="uppage" class="newer-posts" href="${pageContext.request.contextPath }/article/${artiInfo.nowPage-1 }">上一页</a>
						<span class="page-number">第 ${artiInfo.nowPage } 页/共 ${artiInfo.totalPage } 页</span>
						<a id="downpage" class="older-posts" href="${pageContext.request.contextPath }/article/${artiInfo.nowPage+1 }">下一页</a>
					</p>
                </main>
