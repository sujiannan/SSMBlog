...
<html>
  ...
  <body>
    ...
    <form id="itemForm" method="post" action="${pageContext.request.contextPath }/back/bUpdateArtiComplete.do">
	    <table id="dataMsg"  width="80%" align="center"  border="1">
	      <caption>新增日志</caption>  
		  	...
		  	<tr>
		  		...
		  		<td>
		  			<input value="${arti.title }" type="text" name="title" style="width:100%">
		  		</td>
		  	</tr>
		  	<tr>
		  		...
		  		<td>
		  			<c:forEach items="${typeList}" var="msg">
		  				<label><input id="radio${msg.id }" name="typeId" type="radio" value="${msg.id }"  />${msg.typeName }</label> 
		  			</c:forEach>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		//回显context
		artiEditor.html('${arti.context}');
		
		var tId = ${arti.typeId};
		$("#radio${arti.typeId}").attr('checked', 'checked');
	});
	//submit
